...
{
	private static final BundleLogger	LOGGER	= BundleLoggerFactory.getLogger(InstagramInboundTransport.class);
	...
	public synchronized void setup()
	{
		...
		{
			LOGGER.error("APPLY_PROPERTIES_ERROR", error.getMessage());
